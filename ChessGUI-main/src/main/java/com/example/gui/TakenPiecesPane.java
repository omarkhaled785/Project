...
class TakenPiecesPane extends BorderPane {
    ...
    public void redo(final MoveLog moveLog) {
        ...
        Collections.sort(whiteTakenPieces, Comparator.comparingInt(Piece::getPiecePosition));
        Collections.sort(blackTakenPieces, Comparator.comparingInt(Piece::getPiecePosition));
